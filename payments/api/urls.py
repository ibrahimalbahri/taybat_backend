...
urlpatterns = [
    ...
    path("", PaymentMethodListCreateView.as_view(), name="customer-payment-methods"),
    path("<int:pk>/", PaymentMethodUpdateDeleteView.as_view(), name="customer-payment-method-detail"),
